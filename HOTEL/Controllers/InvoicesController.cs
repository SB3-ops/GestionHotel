...
namespace HOTEL.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        {
            var hotelContext = _context.Invoices.Include(i => i.Client).Include(i => i.Reservation);
        ...
        public async Task<IActionResult> Create([Bind("InvoiceId,ReservationId,ClientId,TotalAmount,PaymentStatus")] Invoice invoice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InvoiceId,ReservationId,ClientId,TotalAmount,PaymentStatus")] Invoice invoice)
        {
